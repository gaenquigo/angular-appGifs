// To parse this data:
//
//   import { Convert, ResponseGifsSearch } from "./file";
//
//   const responseGifsSearch = Convert.toResponseGifsSearch(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseGifsSearch {
    data:       Gif[];
...
export class Convert {
    public static toResponseGifsSearch(json: string): ResponseGifsSearch {
        return cast(JSON.parse(json), r("ResponseGifsSearch"));
    }

    public static responseGifsSearchToJson(value: ResponseGifsSearch): string {
        return JSON.stringify(uncast(value, r("ResponseGifsSearch")), null, 2);
    }
}
